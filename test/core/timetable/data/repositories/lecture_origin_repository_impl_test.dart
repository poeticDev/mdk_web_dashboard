...
void main() {
  ...
  late LectureOriginRepositoryImpl repository;

  setUp(() {
    remote = _FakeRemoteDataSource();
    repository = LectureOriginRepositoryImpl(
...
class _FakeRemoteDataSource implements LectureOriginRemoteDataSource {
  LectureOriginQueryRequest? lastQuery;
