...
mixin _$LoginFormState {
 ...
 String get username; String get password; bool get isSubmitting; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,username,password,isSubmitting,errorMessage);

@override
String toString() {
  return 'LoginFormState(username: $username, password: $password, isSubmitting: $isSubmitting, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 String username, String password, bool isSubmitting, String? errorMessage
});
...
/// Create a copy of LoginFormState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? username = null,Object? password = null,Object? isSubmitting = null,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String username,  String password,  bool isSubmitting,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginFormState() when $default != null:
return $default(_that.username,_that.password,_that.isSubmitting,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String username,  String password,  bool isSubmitting,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _LoginFormState():
return $default(_that.username,_that.password,_that.isSubmitting,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String username,  String password,  bool isSubmitting,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _LoginFormState() when $default != null:
return $default(_that.username,_that.password,_that.isSubmitting,_that.errorMessage);case _:
  return null;
...
class _LoginFormState extends LoginFormState {
  const _LoginFormState({this.username = '', this.password = '', this.isSubmitting = false, this.errorMessage}): super._();
...
/// Create a copy of LoginFormState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? username = null,Object? password = null,Object? isSubmitting = null,Object? errorMessage = freezed,}) {
